...
/* jsonb */
DATA(insert (jsonb_agg_finalfn jsonb_agg_transfn jsonbaggstatesend jsonbaggstaterecv jsonb_agg_combine 17));
DATA(insert (jsonb_object_agg_finalfn jsonb_object_agg_transfn jsonbaggstatesend jsonbaggstaterecv jsonb_object_agg_combine 17));
